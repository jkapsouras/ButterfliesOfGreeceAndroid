...
import gr.jkapsouras.butterfliesofgreece.photos.state.PhotosState
import gr.jkapsouras.butterfliesofgreece.photos.state.with
...
//            })
    ...
    private fun updateHeaderState(photos:List<ButterflyPhoto>, photoId:Int) : HeaderState{
        ...
        var photos = mutableListOf<ButterflyPhoto>()
        photos.add(photo)
        headerState = headerState.with(photosToPrint = photos)
        return headerState
    }
